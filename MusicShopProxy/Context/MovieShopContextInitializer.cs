    ...
    public class MovieShopContextInitializer : DropCreateDatabaseIfModelChanges<MovieShopContext>
    {
        protected override void Seed(MovieShopContext context)
        {
            ...
            movies.Add(new Movie()
            {
                ...
                TrailerURL = "https://www.youtube.com/watch?v=Hfb0-U0ydj8",
                Genres = new List<Genre>() { genre2 },
            });
            movies.Add(new Movie()
            {
                ...
                TrailerURL = "https://www.youtube.com/watch?v=3S8a180uYBM",
                Genres = new List<Genre>() { genre2 },
            });
            movies.Add(new Movie()
            {
                ...
                TrailerURL = "https://www.youtube.com/watch?v=C6RU5y2fU6s",
                Genres = new List<Genre>() { genre2 },
            });
            movies.Add(new Movie()
            {
                ...
                TrailerURL = "https://www.youtube.com/watch?v=CQAX-YwX6iM",
                Genres = new List<Genre>() { genre2 },
            });
            movies.Add(new Movie()
            {
            ...
            movies.Add(new Movie()
            {
                ...
                TrailerURL = "https://www.youtube.com/watch?v=f6acw690AqQ",
                Genres = new List<Genre>() { genre2 },
            });
